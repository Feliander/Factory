...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "Лазер №1"))
        self.comboBox.setItemText(1, _translate("MainWindow", "Лазер №2"))
        self.comboBox.setItemText(2, _translate("MainWindow", "Пробивка №1"))
        self.comboBox.setItemText(3, _translate("MainWindow", "Пробивка №2"))
        self.comboBox.setItemText(4, _translate("MainWindow", "Гибка №1"))
        self.comboBox.setItemText(5, _translate("MainWindow", "Гибка №2"))
        self.comboBox.setItemText(6, _translate("MainWindow", "Сварка №1"))
        self.comboBox.setItemText(7, _translate("MainWindow", "Сварка №2"))
        self.comboBox.setItemText(8, _translate("MainWindow", "Сварочный робот №1"))
        self.comboBox.setItemText(9, _translate("MainWindow", "Сварочный робот №2"))
        self.comboBox.setItemText(10, _translate("MainWindow", "Сборка №1"))
        self.comboBox.setItemText(11, _translate("MainWindow", "Сборка №2"))
        self.comboBox.setItemText(12, _translate("MainWindow", "Зачистка №1"))
